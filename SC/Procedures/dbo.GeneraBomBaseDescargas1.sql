...
CREATE PROCEDURE [dbo].[GeneraBomBaseDescargas1] (@fechaini varchar(10), @fechafin varchar(10), @fe_codigo int=0, @SegProc char(1)='N')   as


declare /*@fe_codigo int,*/ @entravigor datetime, @BST_PT int, @fed_indiced int,
