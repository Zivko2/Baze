...
CREATE PROCEDURE [dbo].[SP_FILL_BOM_CICLO1] (@BST_PT INT, @BST_HIJO INT, @BST_ENTRAVIGOR DATETIME, @nivel int/*, @mensaje char(1) output*/) as
--SET NOCOUNT ON 
		 ...
		 OPEN @CursorVar
		  ...
		  BEGIN  
				...
				begin
						...
						exec  SP_FILL_BOM_CICLO1 @BST_PT, @BST_HIJO1, @BST_ENTRAVIGOR, @nivelr--, @mensaje=@mensaje output
