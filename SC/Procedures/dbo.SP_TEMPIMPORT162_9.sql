...
GO
CREATE PROCEDURE [dbo].[SP_TEMPIMPORT162_9] AS
DECLARE @Col_19 varchar(8000),@Col_20 varchar(8000),@FACTEXPDET#FED_OBSERVA varchar(8000),@FACTEXPDET#FED_PES_NET float,@FACTEXPDET#FED_PES_BRU float,@FACTEXPDET#FED_COS_TOT float,@FACTEXP#TQ_CODIGO smallint,@FACTEXP#TN_CODIGO smallint,@FACTEXPDET#FED_NOPARTEAUX varchar(8000),@FACTEXP#US_CODIGO smallint,@FACTEXP#FE_TIPO char,@FACTEXP#TF_CODIGO smallint,@FACTEXP#FE_CONT1_REG varchar(8000),@FACTEXPDET#FED_DESTNAFTA char,@FACTEXP#CP_CODIGO smallint,@FACTEXP#FE_COMENTA varchar(8000),@FACTEXP#FE_FECHA datetime,@FACTEXP#FE_FOLIO varchar(8000),@FACTEXP#FE_CONT1_SELL varchar(8000),@FACTEXP#FE_ORD_COMP varchar(8000),@FACTEXP#FE_TRAC_MX1 varchar(8000),@FACTEXP#FE_TRAC_US1 varchar(8000),@FACTEXP#FE_GUIA1 varchar(8000),@FACTEXP#FE_CONT1_US varchar(8000),@FACTEXP#FE_LIM1 varchar(8000),@FACTEXPDEF#FE_DEFTXT1 varchar(8000),@FACTEXPDEF#FE_DEFTXT2 varchar(8000),@FACTEXP#FE_TRAC_CHO1 varchar(8000),@FACTEXP#FE_MANIF varchar(8000),@FACTEXPDET#FED_NOPARTE varchar(8000),@FACTEXPDET#FED_CANT float,@FACTEXPDET#FED_CANTEMP float,@FACTEXPDET#MA_EMPAQUE int,@Cod_15 varchar(8000),@Cod_18 varchar(8000)
...
SELECT @ACTUALIZA=0
SELECT @ANEXA=1
DELETE FROM REGISTROSIMPORTADOS where RI_USERID = 9
...
DECLARE CUR_TEMPIMPORT162_9 CURSOR FOR
SELECT MAX(Col_19),MAX(Col_20),MAX(Cod_15),MAX(Cod_18),MAX(FACTEXP9#TQ_CODIGO),MAX(FACTEXP9#TN_CODIGO),MAX(FACTEXP9#US_CODIGO),FACTEXP9#FE_TIPO,MAX(FACTEXP9#TF_CODIGO),MAX(FACTEXP9#FE_CONT1_REG),MAX(FACTEXP9#CP_CODIGO),MAX(FACTEXP9#FE_COMENTA),MAX(FACTEXP9#FE_FECHA),FACTEXP9#FE_FOLIO,MAX(FACTEXP9#FE_CONT1_SELL),MAX(FACTEXP9#FE_ORD_COMP),MAX(FACTEXP9#FE_TRAC_MX1),MAX(FACTEXP9#FE_TRAC_US1),MAX(FACTEXP9#FE_GUIA1),MAX(FACTEXP9#FE_CONT1_US),MAX(FACTEXP9#FE_LIM1),MAX(FACTEXP9#FE_TRAC_CHO1),MAX(FACTEXP9#FE_MANIF),FACTEXPDEF9#FE_DEFTXT1,FACTEXPDEF9#FE_DEFTXT2 FROM TEMPIMPORT162_9 WHERE FACTEXP9#FE_FOLIO NOT IN (select factexp.fe_folio from factexp WHERE factexp.fe_estatus in ('A', 'C', 'P', 'L', 'S') or fe_iniciocruce='S') GROUP BY FACTEXP9#FE_TIPO,FACTEXP9#FE_FOLIO,FACTEXPDEF9#FE_DEFTXT1,FACTEXPDEF9#FE_DEFTXT2
OPEN CUR_TEMPIMPORT162_9
FETCH NEXT FROM CUR_TEMPIMPORT162_9 INTO @Col_19 ,@Col_20 ,@Cod_15 ,@Cod_18 ,@FACTEXP#TQ_CODIGO ,@FACTEXP#TN_CODIGO ,@FACTEXP#US_CODIGO ,@FACTEXP#FE_TIPO ,@FACTEXP#TF_CODIGO ,@FACTEXP#FE_CONT1_REG ,@FACTEXP#CP_CODIGO ,@FACTEXP#FE_COMENTA ,@FACTEXP#FE_FECHA ,@FACTEXP#FE_FOLIO ,@FACTEXP#FE_CONT1_SELL ,@FACTEXP#FE_ORD_COMP ,@FACTEXP#FE_TRAC_MX1 ,@FACTEXP#FE_TRAC_US1 ,@FACTEXP#FE_GUIA1 ,@FACTEXP#FE_CONT1_US ,@FACTEXP#FE_LIM1 ,@FACTEXP#FE_TRAC_CHO1 ,@FACTEXP#FE_MANIF ,@FACTEXPDEF#FE_DEFTXT1 ,@FACTEXPDEF#FE_DEFTXT2 
...
BEGIN
  ...
  BEGIN
          ...
          INSERT INTO FACTEXP (FE_CODIGO,TQ_CODIGO ,TN_CODIGO ,US_CODIGO ,FE_TIPO ,TF_CODIGO ,FE_CONT1_REG ,CP_CODIGO ,FE_COMENTA ,FE_FECHA ,FE_FOLIO ,FE_CONT1_SELL ,FE_ORD_COMP ,FE_TRAC_MX1 ,FE_TRAC_US1 ,FE_GUIA1 ,FE_CONT1_US ,FE_LIM1 ,FE_TRAC_CHO1 ,FE_MANIF ,FE_DESCRIPTION1 ,FE_HEADER ,FE_FOOTER ,AG_MX ,AG_US ,CL_PROD ,DI_PROD ,CL_COMP ,DI_COMP ,CL_COMPFIN ,DI_COMPFIN ,CL_EXP ,DI_EXP ,CL_EXPFIN ,DI_EXPFIN ,CL_DESTINI ,DI_DESTINI ,CL_DESTFIN ,DI_DESTFIN ,CL_VEND ,DI_VEND ,CL_IMP ,DI_IMP ,PU_CARGA ,PU_SALIDA ,PU_ENTRADA ,PU_DESTINO ,CT_COMPANY1 ,CT_COMPANY2 ,IT_COMPANY1 ,MT_COMPANY1 ,IT_COMPANY2 ,MT_COMPANY2 ,FE_TIPOCAMBIO ,MO_CODIGO ,FE_PINICIAL ,FE_PFINAL ,AGT_CODIGO ) VALUES (@CONSECUTIVO,@FACTEXP#TQ_CODIGO ,@FACTEXP#TN_CODIGO ,@FACTEXP#US_CODIGO ,@FACTEXP#FE_TIPO ,@FACTEXP#TF_CODIGO ,@FACTEXP#FE_CONT1_REG ,@FACTEXP#CP_CODIGO ,@FACTEXP#FE_COMENTA ,@FACTEXP#FE_FECHA ,@FACTEXP#FE_FOLIO ,@FACTEXP#FE_CONT1_SELL ,@FACTEXP#FE_ORD_COMP ,@FACTEXP#FE_TRAC_MX1 ,@FACTEXP#FE_TRAC_US1 ,@FACTEXP#FE_GUIA1 ,@FACTEXP#FE_CONT1_US ,@FACTEXP#FE_LIM1 ,@FACTEXP#FE_TRAC_CHO1 ,@FACTEXP#FE_MANIF ,@FACTEXP#FE_DESCRIPTION1,@FACTEXP#FE_HEADER,@FACTEXP#FE_FOOTER,@FACTEXP#AG_MX,@FACTEXP#AG_US,@FACTEXP#CL_PROD,@FACTEXP#DI_PROD,@FACTEXP#CL_COMP,@FACTEXP#DI_COMP,@FACTEXP#CL_COMPFIN,@FACTEXP#DI_COMPFIN,@FACTEXP#CL_EXP,@FACTEXP#DI_EXP,@FACTEXP#CL_EXPFIN,@FACTEXP#DI_EXPFIN,@FACTEXP#CL_DESTINI,@FACTEXP#DI_DESTINI,@FACTEXP#CL_DESTFIN,@FACTEXP#DI_DESTFIN,@FACTEXP#CL_VEND,@FACTEXP#DI_VEND,@FACTEXP#CL_IMP,@FACTEXP#DI_IMP,@FACTEXP#PU_CARGA,@FACTEXP#PU_SALIDA,@FACTEXP#PU_ENTRADA,@FACTEXP#PU_DESTINO,@FACTEXP#CT_COMPANY1,@FACTEXP#CT_COMPANY2,@FACTEXP#IT_COMPANY1,@FACTEXP#MT_COMPANY1,@FACTEXP#IT_COMPANY2,@FACTEXP#MT_COMPANY2,@FACTEXP#FE_TIPOCAMBIO,@FACTEXP#MO_CODIGO,@FACTEXP#FE_PINICIAL,@FACTEXP#FE_PFINAL,@FACTEXP#AGT_CODIGO)
               INSERT INTO REGISTROSIMPORTADOS (RI_REGISTRO,RI_TIPO,RI_CBFORMA, RI_USERID) VALUES                                               ('FE_FOLIO = '+CONVERT(varchar(100),@FACTEXP#FE_FOLIO)+', '+'FE_FECHA = '+CONVERT(varchar(100),@FACTEXP#FE_FECHA),'I',20,9) 
 if exists (select * from sysobjects where name='sysusrlog62')                 insert into sysusrlog62 (user_id, mov_id, referencia, frmtag, fechahora) values                                                        (9, 1 ,'FE_FOLIO = '+CONVERT(varchar(100),@FACTEXP#FE_FOLIO)+', '+'FE_FECHA = '+CONVERT(varchar(100),@FACTEXP#FE_FECHA),62, getdate()) 
                INSERT INTO FACTEXPDEF (FE_CODIGO,FE_DEFTXT1 ,FE_DEFTXT2 ) VALUES (@CONSECUTIVO,@FACTEXPDEF#FE_DEFTXT1 ,@FACTEXPDEF#FE_DEFTXT2 )
        DECLARE CUR_TEMPIMPORT162_9DET CURSOR FOR
        SELECT MAX(Col_19),MAX(Col_20),MAX(Cod_15),MAX(Cod_18),FACTEXPDET9#FED_OBSERVA,SUM(FACTEXPDET9#FED_PES_NET),SUM(FACTEXPDET9#FED_PES_BRU),SUM(FACTEXPDET9#FED_COS_TOT),FACTEXPDET9#FED_NOPARTEAUX,MAX(FACTEXPDET9#FED_DESTNAFTA),FACTEXPDET9#FED_NOPARTE,SUM(FACTEXPDET9#FED_CANT),SUM(FACTEXPDET9#FED_CANTEMP),FACTEXPDET9#MA_EMPAQUE FROM TEMPIMPORT162_9  WHERE FACTEXP9#FE_FOLIO=@FACTEXP#FE_FOLIO AND FACTEXP9#FE_TIPO=@FACTEXP#FE_TIPO AND FACTEXP9#TQ_CODIGO=@FACTEXP#TQ_CODIGO GROUP BY FACTEXPDET9#FED_OBSERVA,FACTEXPDET9#FED_NOPARTEAUX,FACTEXPDET9#FED_NOPARTE,FACTEXPDET9#MA_EMPAQUE
        OPEN CUR_TEMPIMPORT162_9DET
                      FETCH NEXT FROM CUR_TEMPIMPORT162_9DET INTO @Col_19 ,@Col_20 ,@Cod_15 ,@Cod_18 ,@FACTEXPDET#FED_OBSERVA ,@FACTEXPDET#FED_PES_NET ,@FACTEXPDET#FED_PES_BRU ,@FACTEXPDET#FED_COS_TOT ,@FACTEXPDET#FED_NOPARTEAUX ,@FACTEXPDET#FED_DESTNAFTA ,@FACTEXPDET#FED_NOPARTE ,@FACTEXPDET#FED_CANT ,@FACTEXPDET#FED_CANTEMP ,@FACTEXPDET#MA_EMPAQUE 
        WHILE (@@FETCH_STATUS = 0)
        BEGIN
          ...
          EXEC SP_GETCONSECUTIVO @TIPO='FED',@VALUE=@CONSDET OUTPUT
             ...
             FACTEXP.FE_CODIGO = FACTEXPDET.FE_CODIGO
              ...
              update FACTEXPDET set FED_PES_NET = ( FACTEXPDET.FED_CANT *FACTEXPDET.FED_PES_UNI )
              from FACTEXPDET
              left outer join FACTEXP on  
             FACTEXP.FE_CODIGO = FACTEXPDET.FE_CODIGO
              where FACTEXPDET.FED_INDICED = @CONSDET
              update FACTEXPDET set FED_PES_BRU = ( FACTEXPDET.FED_CANT *FACTEXPDET.FED_PES_UNI )
              from FACTEXPDET
              left outer join FACTEXP on  
             FACTEXP.FE_CODIGO = FACTEXPDET.FE_CODIGO
              where FACTEXPDET.FED_INDICED = @CONSDET
                      FETCH NEXT FROM CUR_TEMPIMPORT162_9DET INTO @Col_19 ,@Col_20 ,@Cod_15 ,@Cod_18 ,@FACTEXPDET#FED_OBSERVA ,@FACTEXPDET#FED_PES_NET ,@FACTEXPDET#FED_PES_BRU ,@FACTEXPDET#FED_COS_TOT ,@FACTEXPDET#FED_NOPARTEAUX ,@FACTEXPDET#FED_DESTNAFTA ,@FACTEXPDET#FED_NOPARTE ,@FACTEXPDET#FED_CANT ,@FACTEXPDET#FED_CANTEMP ,@FACTEXPDET#MA_EMPAQUE 
        END
        CLOSE CUR_TEMPIMPORT162_9DET
        DEALLOCATE CUR_TEMPIMPORT162_9DET
  END
  FETCH NEXT FROM CUR_TEMPIMPORT162_9 INTO @Col_19 ,@Col_20 ,@Cod_15 ,@Cod_18 ,@FACTEXP#TQ_CODIGO ,@FACTEXP#TN_CODIGO ,@FACTEXP#US_CODIGO ,@FACTEXP#FE_TIPO ,@FACTEXP#TF_CODIGO ,@FACTEXP#FE_CONT1_REG ,@FACTEXP#CP_CODIGO ,@FACTEXP#FE_COMENTA ,@FACTEXP#FE_FECHA ,@FACTEXP#FE_FOLIO ,@FACTEXP#FE_CONT1_SELL ,@FACTEXP#FE_ORD_COMP ,@FACTEXP#FE_TRAC_MX1 ,@FACTEXP#FE_TRAC_US1 ,@FACTEXP#FE_GUIA1 ,@FACTEXP#FE_CONT1_US ,@FACTEXP#FE_LIM1 ,@FACTEXP#FE_TRAC_CHO1 ,@FACTEXP#FE_MANIF ,@FACTEXPDEF#FE_DEFTXT1 ,@FACTEXPDEF#FE_DEFTXT2 
END
CLOSE CUR_TEMPIMPORT162_9
DEALLOCATE CUR_TEMPIMPORT162_9
GO
