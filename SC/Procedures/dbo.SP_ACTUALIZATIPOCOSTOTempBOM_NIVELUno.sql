...
CREATE PROCEDURE [dbo].[SP_ACTUALIZATIPOCOSTOTempBOM_NIVELUno] (@spi_codigo int=22, @uservar varchar(50)='1')    as
	...
	begin
		...
		esAnadido=case when MAESTRO.MA_REPARA <>''A'' then ''N'' else ''S'' end,
			...
			FROM         BOM_STRUCT INNER JOIN
			                      ...
			                      TempBOM_NIVEL'+@uservar+' ON BOM_STRUCT.BSU_SUBENSAMBLE = TempBOM_NIVEL'+@uservar+'.BST_HIJO
