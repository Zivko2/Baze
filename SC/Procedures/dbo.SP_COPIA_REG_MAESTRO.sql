...
CREATE PROCEDURE [dbo].[SP_COPIA_REG_MAESTRO] (@FUENTE INT,@DESTINO INT)  as
...
declare @EQ_CANTIDAD decimal(28,14)
	...
	begin
		...
		MA_NG_ADD, MA_NG_EMP, MA_COSTO, MA_GRAVA_VA, TV_CODIGO, TCO_CODIGO, MA_CODIGO)
			...
			isnull(MA_NG_ADD,0), isnull(MA_NG_EMP,0), isnull(MA_COSTO,0), isnull(MA_GRAVA_VA,'S'), TV_CODIGO, TCO_CODIGO, @DESTINO
