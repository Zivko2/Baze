...
CREATE PROCEDURE [dbo].[SP_FILL_BOM_ESTRUCTDESC1] (@BST_PT INT, @BST_HIJO INT, @BST_ENTRAVIGOR DATETIME, @BST_PERINI DATETIME, @CF_USATIPOADQUISICION char(1), @BST_INCORPOR1 decimal(38,6), @CF_NIVELES int, @nivel int, @mensaje char(1) output)   as
...
declare @BST_HIJO1 int, @BST_INCORPOR decimal(38,6), @BST_DISCH char(1), @TI_CODIGO char(1), @ME_CODIGO int, @FACTCONV decimal(28,14), 
	...
	SET @nivelr=@nivel+1
			...
			insert into bom_estructdesc (BST_HIJO, BST_INCORPOR, BST_DISCH, TI_CODIGO,  ME_CODIGO, FACTCONV, BST_PERINI, BST_PERFIN, ME_GEN, 
...
AND SUM(dbo.BOM_STRUCT.BST_INCORPOR) >0
 ...
 OPEN @CursorVar
  ...
  BEGIN  
	...
	if @@NESTLEVEL <31
		exec  SP_FILL_BOM_ESTRUCTDESC1 @BST_PT, @BST_HIJO1, @BST_ENTRAVIGOR, @BST_PERINI1, 
