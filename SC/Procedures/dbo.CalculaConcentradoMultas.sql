...
CREATE procedure dbo.CalculaConcentradoMultas ( @tipoDatos char(1), @tipoPedimento char(1), @fecha datetime, @IniciaPeriodo datetime, @TerminaPeriodo datetime)    as

SET NOCOUNT ON 
BEGIN
if not exists (select * from sysobjects where name = 'Temporal_ConcentradoMultasGeneral') 
	...
	delete from Temporal_ConcentradoMultasGeneral
