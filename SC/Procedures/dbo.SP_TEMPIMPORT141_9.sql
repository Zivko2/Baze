...
GO
CREATE PROCEDURE [dbo].[SP_TEMPIMPORT141_9] AS
DECLARE @Col_2 varchar(8000),@Col_3 varchar(8000),@Col_4 varchar(8000),@Col_5 varchar(8000),@Col_6 varchar(8000),@Col_7 varchar(8000),@Col_8 varchar(8000),@MAESTROCOST#MA_COSTO float,@MAESTRO#MA_NOPARTEAUX varchar(8000),@MAESTROCOST#SPI_CODIGO int,@MAESTROCOST#MA_PERINI datetime,@MAESTROCOST#TCO_CODIGO smallint,@MAESTRO#MA_INV_GEN char,@MAESTRO#MA_NOPARTE varchar(8000),@MAESTROCOST#MA_GRAV_MP float,@MAESTROCOST#MA_NG_MP float,@MAESTROCOST#MA_GRAV_EMP float,@MAESTROCOST#MA_NG_EMP float,@MAESTROCOST#MA_GRAV_ADD float,@MAESTROCOST#MA_GRAV_GI_MX float,@MAESTROCOST#MA_GRAV_MO float,@MAESTRODEF#MA_DEFNO1 int
...
DECLARE CUR_TEMPIMPORT141_9 CURSOR FOR
SELECT MAX(Col_2),MAX(Col_3),MAX(Col_4),MAX(Col_5),MAX(Col_6),MAX(Col_7),MAX(Col_8),MAESTRO9#MA_NOPARTEAUX,MAESTRO9#MA_INV_GEN,MAESTRO9#MA_NOPARTE,MAX(MAESTRODEF9#MA_DEFNO1) FROM TEMPIMPORT141_9 GROUP BY MAESTRO9#MA_NOPARTEAUX,MAESTRO9#MA_INV_GEN,MAESTRO9#MA_NOPARTE
OPEN CUR_TEMPIMPORT141_9
FETCH NEXT FROM CUR_TEMPIMPORT141_9 INTO @Col_2 ,@Col_3 ,@Col_4 ,@Col_5 ,@Col_6 ,@Col_7 ,@Col_8 ,@MAESTRO#MA_NOPARTEAUX ,@MAESTRO#MA_INV_GEN ,@MAESTRO#MA_NOPARTE ,@MAESTRODEF#MA_DEFNO1 
...
BEGIN
  ...
  BEGIN
          ...
          BEGIN
              ...
              begin tran UPDATE MAESTRO SET MA_NOPARTEAUX=@MAESTRO#MA_NOPARTEAUX, MA_INV_GEN=@MAESTRO#MA_INV_GEN, MA_NOPARTE=@MAESTRO#MA_NOPARTE WHERE MA_NOPARTE=@MAESTRO#MA_NOPARTE AND MA_INV_GEN=@MAESTRO#MA_INV_GEN AND MA_NOPARTEAUX=@MAESTRO#MA_NOPARTEAUX commit tran 
               INSERT INTO REGISTROSIMPORTADOS (RI_REGISTRO,RI_TIPO,RI_CBFORMA,RI_USERID) VALUES                                               ('MA_NOPARTE = '+CONVERT(varchar(100),@MAESTRO#MA_NOPARTE)+', '+'MA_INV_GEN = '+CONVERT(varchar(100),@MAESTRO#MA_INV_GEN)+', '+'MA_NOPARTEAUX = '+CONVERT(varchar(100),@MAESTRO#MA_NOPARTEAUX),'A',28,9) 
 if exists (select * from sysobjects where name='sysusrlog41')     insert into sysusrlog41 (user_id, mov_id, referencia, frmtag, fechahora) values                                                        (9, 2 ,'MA_NOPARTE = '+CONVERT(varchar(100),@MAESTRO#MA_NOPARTE)+', '+'MA_INV_GEN = '+CONVERT(varchar(100),@MAESTRO#MA_INV_GEN)+', '+'MA_NOPARTEAUX = '+CONVERT(varchar(100),@MAESTRO#MA_NOPARTEAUX),41, getdate()) 
          ...
          ELSE   begin tran  update MAESTRODEF set MA_DEFNO1 =@MAESTRODEF#MA_DEFNO1  where MA_CODIGO=@CONSECUTIVO commit tran 
                      DECLARE CUR_TEMPIMPORT141_9DET CURSOR FOR
                       SELECT MAX(Col_2),MAX(Col_3),MAX(Col_4),MAX(Col_5),MAX(Col_6),MAX(Col_7),MAX(Col_8),MAX(MAESTROCOST9#MA_COSTO),MAX(MAESTROCOST9#SPI_CODIGO),MAX(MAESTROCOST9#MA_PERINI),MAX(MAESTROCOST9#TCO_CODIGO),MAX(MAESTROCOST9#MA_GRAV_MP),MAX(MAESTROCOST9#MA_NG_MP),MAX(MAESTROCOST9#MA_GRAV_EMP),MAX(MAESTROCOST9#MA_NG_EMP),MAX(MAESTROCOST9#MA_GRAV_ADD),MAX(MAESTROCOST9#MA_GRAV_GI_MX),MAX(MAESTROCOST9#MA_GRAV_MO) FROM TEMPIMPORT141_9  WHERE MAESTRO9#MA_NOPARTE=@MAESTRO#MA_NOPARTE AND MAESTRO9#MA_INV_GEN=@MAESTRO#MA_INV_GEN AND MAESTRO9#MA_NOPARTEAUX=@MAESTRO#MA_NOPARTEAUX
                      OPEN CUR_TEMPIMPORT141_9DET
                      FETCH NEXT FROM CUR_TEMPIMPORT141_9DET INTO @Col_2 ,@Col_3 ,@Col_4 ,@Col_5 ,@Col_6 ,@Col_7 ,@Col_8 ,@MAESTROCOST#MA_COSTO ,@MAESTROCOST#SPI_CODIGO ,@MAESTROCOST#MA_PERINI ,@MAESTROCOST#TCO_CODIGO ,@MAESTROCOST#MA_GRAV_MP ,@MAESTROCOST#MA_NG_MP ,@MAESTROCOST#MA_GRAV_EMP ,@MAESTROCOST#MA_NG_EMP ,@MAESTROCOST#MA_GRAV_ADD ,@MAESTROCOST#MA_GRAV_GI_MX ,@MAESTROCOST#MA_GRAV_MO 
                      WHILE (@@FETCH_STATUS = 0)
                      BEGIN
                         ...
                         IF ISNULL(convert(varchar(10),@MAESTROCOST#TCO_CODIGO),'zzzzzzzz') <> 'zzzzzzzz' AND ISNULL(convert(varchar(10),@MAESTROCOST#SPI_CODIGO),'zzzzzzzz') <> 'zzzzzzzz' AND ISNULL(convert(varchar(10),@MAESTROCOST#MA_PERINI),'zzzzzzzz') <> 'zzzzzzzz'
                           BEGIN
                                ...
                                BEGIN
                                  ...
                                  commit tran
                                END
                                  begin tran INSERT INTO MAESTROCOST (MA_CODIGO,MA_COSTO ,SPI_CODIGO ,MA_PERINI ,TCO_CODIGO ,MA_GRAV_MP ,MA_NG_MP ,MA_GRAV_EMP ,MA_NG_EMP ,MA_GRAV_ADD ,MA_GRAV_GI_MX ,MA_GRAV_MO ) VALUES (@CONSECUTIVO,@MAESTROCOST#MA_COSTO ,@MAESTROCOST#SPI_CODIGO ,@MAESTROCOST#MA_PERINI ,@MAESTROCOST#TCO_CODIGO ,@MAESTROCOST#MA_GRAV_MP ,@MAESTROCOST#MA_NG_MP ,@MAESTROCOST#MA_GRAV_EMP ,@MAESTROCOST#MA_NG_EMP ,@MAESTROCOST#MA_GRAV_ADD ,@MAESTROCOST#MA_GRAV_GI_MX ,@MAESTROCOST#MA_GRAV_MO ) commit tran
 
                           END
                    END
                          ELSE
                          BEGIN
                                 begin tran UPDATE MAESTROCOST SET MA_COSTO=@MAESTROCOST#MA_COSTO, SPI_CODIGO=@MAESTROCOST#SPI_CODIGO, MA_PERINI=@MAESTROCOST#MA_PERINI, TCO_CODIGO=@MAESTROCOST#TCO_CODIGO, MA_GRAV_MP=@MAESTROCOST#MA_GRAV_MP, MA_NG_MP=@MAESTROCOST#MA_NG_MP, MA_GRAV_EMP=@MAESTROCOST#MA_GRAV_EMP, MA_NG_EMP=@MAESTROCOST#MA_NG_EMP, MA_GRAV_ADD=@MAESTROCOST#MA_GRAV_ADD, MA_GRAV_GI_MX=@MAESTROCOST#MA_GRAV_GI_MX, MA_GRAV_MO=@MAESTROCOST#MA_GRAV_MO WHERE MA_CODIGO = @CONSECUTIVO AND TCO_CODIGO=@MAESTROCOST#TCO_CODIGO AND SPI_CODIGO=@MAESTROCOST#SPI_CODIGO AND MA_PERINI=@MAESTROCOST#MA_PERINI commit tran 
                          END
                      FETCH NEXT FROM CUR_TEMPIMPORT141_9DET INTO @Col_2 ,@Col_3 ,@Col_4 ,@Col_5 ,@Col_6 ,@Col_7 ,@Col_8 ,@MAESTROCOST#MA_COSTO ,@MAESTROCOST#SPI_CODIGO ,@MAESTROCOST#MA_PERINI ,@MAESTROCOST#TCO_CODIGO ,@MAESTROCOST#MA_GRAV_MP ,@MAESTROCOST#MA_NG_MP ,@MAESTROCOST#MA_GRAV_EMP ,@MAESTROCOST#MA_NG_EMP ,@MAESTROCOST#MA_GRAV_ADD ,@MAESTROCOST#MA_GRAV_GI_MX ,@MAESTROCOST#MA_GRAV_MO 
        END
        CLOSE CUR_TEMPIMPORT141_9DET
        DEALLOCATE CUR_TEMPIMPORT141_9DET
          END
  END
  FETCH NEXT FROM CUR_TEMPIMPORT141_9 INTO @Col_2 ,@Col_3 ,@Col_4 ,@Col_5 ,@Col_6 ,@Col_7 ,@Col_8 ,@MAESTRO#MA_NOPARTEAUX ,@MAESTRO#MA_INV_GEN ,@MAESTRO#MA_NOPARTE ,@MAESTRODEF#MA_DEFNO1 
END
CLOSE CUR_TEMPIMPORT141_9
DEALLOCATE CUR_TEMPIMPORT141_9
GO
