...
CREATE procedure dbo.CalculaConcentradoDescargasMultas ( @tipoDatos char(1), @fecha datetime, @TipoSaldo char(1))    as

SET NOCOUNT ON 
BEGIN
if not exists (select * from sysobjects where name = 'TemporalDescargas_ConcentradoMultasGeneral') 
	...
	delete from TemporalDescargas_ConcentradoMultasGeneral
