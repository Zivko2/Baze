...
CREATE TABLE [Person].[EmailAddress] (
		...
		[EmailAddressss]       [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
CREATE NONCLUSTERED INDEX [IX_EmailAddress_EmailAddress]
	ON [Person].[EmailAddress] ([EmailAddressss])
	ON [PRIMARY]
GO
...
GO
EXEC sp_addextendedproperty N'MS_Description', N'E-mail address for the person.', 'SCHEMA', N'Person', 'TABLE', N'EmailAddress', 'COLUMN', N'EmailAddressss'
GO
