...
ALTER TABLE [HumanResources].[Employee]
	WITH CHECK
	ADD CONSTRAINT [FK_Employee_Employeej]
	FOREIGN KEY ([BusinessEntityID]) REFERENCES [HumanResources].[Employeej] ([BusinessEntityID])
ALTER TABLE [HumanResources].[Employee]
	CHECK CONSTRAINT [FK_Employee_Employeej]
