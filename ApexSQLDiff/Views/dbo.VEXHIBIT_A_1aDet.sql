...
/* material gravable*/
CREATE VIEW dbo.VEXHIBIT_A_1aDet
with encryption as
SELECT     SUM(CSA_GRAV_MAT) AS CSA_GRAV_MAT, CS_CODIGO, SUM(CSA_EMP_FO) AS CSA_EMP_FO, FE_CODIGO, AR_FRACCION, FED_NOPARTE
FROM         (SELECT     SUM(((FACTEXPDET.FED_GRA_MP + FACTEXPDET.FED_GRA_ADD+FACTEXPDET.FED_NG_MP) -FACTEXPDET.FED_NG_USA) * FACTEXPDET.FED_CANT) AS CSA_GRAV_MAT, dbo.VRELCSFACTEXP.CS_CODIGO, 
		                      SUM(dbo.FACTEXPDET.FED_GRA_EMP *FACTEXPDET.FED_CANT) AS CSA_EMP_FO, dbo.FACTEXP.FE_CODIGO, dbo.FACTEXP.FE_FOLIO, dbo.ARANCEL.AR_FRACCION, dbo.FACTEXPDET.FED_NOPARTE
		...
		SELECT     SUM(dbo.FACTEXPDET.FED_COS_UNI * dbo.FACTEXPDET.FED_CANT) AS CSA_GRAV_MAT, dbo.VRELCSFACTEXP.CS_CODIGO, 
		                      0 AS CSA_EMP_FO, dbo.FACTEXP.FE_CODIGO, dbo.FACTEXP.FE_FOLIO, dbo.ARANCEL.AR_FRACCION, dbo.FACTEXPDET.FED_NOPARTE
		FROM         dbo.CONFIGURATIPO RIGHT OUTER JOIN
		                      dbo.ARANCEL RIGHT OUTER JOIN
		                      dbo.FACTEXPDET ON dbo.ARANCEL.AR_CODIGO = dbo.FACTEXPDET.AR_IMPFO ON 
		                      dbo.CONFIGURATIPO.TI_CODIGO = dbo.FACTEXPDET.TI_CODIGO RIGHT OUTER JOIN
		...
		SELECT     0 AS CSA_GRAV_MAT, dbo.VRELCSFACTEXP.CS_CODIGO, 
		                      SUM(dbo.FACTEXPDET.FED_COS_UNI * dbo.FACTEXPDET.FED_CANT) AS CSA_EMP_FO, dbo.FACTEXP.FE_CODIGO, dbo.FACTEXP.FE_FOLIO, dbo.ARANCEL.AR_FRACCION, dbo.FACTEXPDET.FED_NOPARTE
		FROM         dbo.CONFIGURATIPO RIGHT OUTER JOIN
		                      dbo.ARANCEL RIGHT OUTER JOIN
		                      dbo.FACTEXPDET ON dbo.ARANCEL.AR_CODIGO = dbo.FACTEXPDET.AR_IMPFO ON 
		                      dbo.CONFIGURATIPO.TI_CODIGO = dbo.FACTEXPDET.TI_CODIGO RIGHT OUTER JOIN
...
GROUP BY CS_CODIGO, FE_CODIGO, AR_FRACCION, FED_NOPARTE
