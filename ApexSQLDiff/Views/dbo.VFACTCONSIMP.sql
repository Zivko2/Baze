...
SELECT     dbo.FACTCONS.FC_CODIGO, dbo.AGENCIAPATENTE.AGT_PATENTE collate database_default + '-' + dbo.FACTCONS.FC_FOLIO collate database_default AS agencia_folio, dbo.FACTCONS.FC_TIPO, 
                      ...
                      dbo.FACTCONS.US_CODIGO, dbo.FACTCONS.CL_CODIGO, dbo.FACTCONS.FC_CONSECUTIVOREMESA, dbo.CLAVEPED.CP_CLAVE, 
                      dbo.CLIENTE.CL_CODEHTC CL_CORTO, dbo.FACTCONS.PR_CODIGO
...
WHERE     ((dbo.FACTCONS.FC_TIPO = 'E') OR
