...
GO
CREATE VIEW dbo.VPEDIMPREVISION7
	 AS
	...
	AND dbo.PEDIMPDET.PID_INDICED IN (SELECT LISTAPEDAFECTADOS7.PID_INDICED FROM LISTAPEDAFECTADOS7 GROUP BY LISTAPEDAFECTADOS7.PID_INDICED)
GO
