...
CREATE VIEW dbo.VINEGIEMPFO
with encryption as
SELECT     SUM(dbo.PEDIMPDET.PID_COS_UNIGEN * dbo.KARDESPED.KAP_CANTDESC * dbo.PEDIMP.PI_TIP_CAM) AS COSTOTOTALEMPFO, 
                      dbo.INEGI.IG_CODIGO
...
WHERE      (dbo.CONFIGURATIPO.CFT_TIPO IN ('E')) AND (dbo.CONFIGURACLAVEPED.CCP_TIPO IN ('IT', 'IE', 'RG'))
