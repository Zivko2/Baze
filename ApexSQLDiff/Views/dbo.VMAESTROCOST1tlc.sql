...
GO
CREATE VIEW dbo.VMAESTROCOST1tlc
with encryption as
...
WHERE     ((((dbo.CONFIGURATIPO.CFT_TIPO <> 'P' AND dbo.CONFIGURATIPO.CFT_TIPO <> 'S') OR dbo.MAESTRO.MA_TIP_ENS = 'C') 
	...
	AND (ISNULL(dbo.MAESTRO.MA_INV_GEN,'I') = 'I') AND (dbo.MAESTROCOST.MA_PERINI <= 'Jul 30 2009')
	AND (dbo.MAESTROCOST.MA_PERFIN >= 'Jul 30 2009')
