...
CREATE VIEW dbo.VINEGIEXPV1
with encryption as
SELECT     SUM(dbo.FACTEXPDET.FED_COS_TOT * dbo.FACTEXP.FE_TIPOCAMBIO) AS COSTOTOTALEXPV1, dbo.INEGI.IG_CODIGO
...
WHERE     (dbo.FACTEXP.FE_CANCELADO = 'N') AND (dbo.CONFIGURATFACT.CFF_TIPO IN ('EV'))
