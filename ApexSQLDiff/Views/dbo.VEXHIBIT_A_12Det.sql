...
CREATE VIEW dbo.VEXHIBIT_A_12Det
with encryption as
SELECT     SUM(CSA_98020060) AS CSA_98020060, CS_CODIGO, FE_CODIGO, AR_FRACCION
FROM         (SELECT     SUM(dbo.FACTEXPDET.FED_NG_USA * dbo.FACTEXPDET.FED_CANT) AS CSA_98020060, 
	...
	WHERE     (dbo.CONFIGURATEMBARQUE.CFQ_TIPO <> 'D') AND (dbo.FACTEXP.TN_CODIGO = 2 OR
	                      ...
	                      dbo.FACTEXP.TN_CODIGO = 5 OR dbo.FACTEXP.TN_CODIGO = 8 OR dbo.FACTEXP.TN_CODIGO = 9) AND (REPLACE(dbo.ARANCEL.AR_FRACCION, '.', '') LIKE '98020060%' OR 
	                      REPLACE(ARANCEL_1.AR_FRACCION, '.', '') LIKE '98020060%')
