...
CREATE PROCEDURE [dbo].[SP_GENERAFACTEXPBASEDESC] (@FE_CODIGO INT)   as

declare @folio varchar(25), @fe_folio varchar(25), @CONSECUTIVO int, @fe_fecha varchar(11), @fed_indiced int
