...
CREATE PROCEDURE [dbo].[SP_FILL_TempBOM_DESCALM] (@END_INDICED INT, @BST_PT Int, @BST_ENTRAVIGOR DateTime, @END_CANT decimal(38,6), @CODIGOFACTURA INT, @ALMORIGEN INT, @ALMDESTINO INT, @ALMDORIGEN INT, @ALMDDESTINO INT)   as


declare @BST_HIJO int, @BST_INCORPOR decimal(38,6), @BST_DISCH char(1), @TI_CODIGO char(1), @ME_CODIGO int, @FACTCONVALM decimal(38,6), 
	...
	if @CF_USATIPOADQUISICION='S'
		begin
			...
			begin
				...
				exec  SP_FILL_TempBOM_DESCALM1 @END_INDICED, @BST_PT, @BST_HIJO, @BST_ENTRAVIGOR, @BST_PERINI, 
