...
CREATE PROCEDURE [dbo].[SP_CreaTempImpFile1_2]   as


exec sp_droptable 'TempImpFile1_2'
CREATE TABLE [dbo].[TempImpFile1_2] (
	...
	[UMofPart] [varchar] (6) COLLATE SQL_Latin1_General_CP1_CI_AS NULL ,
