...
CREATE PROCEDURE dbo.SP_DescRetrabajoDespFed (@fed_indiced Int)   as

SET NOCOUNT ON 

DECLARE @CodigoFactura int, @fe_tipo char(1), @ma_codigo int, @ma_hijo int, @ti_hijo int, @ade_cant decimal(38,6), @me_com int, @ade_saldo decimal(38,6), @ma_peso_kg decimal(38,6)
...
HAVING      (dbo.FACTEXPDET.FED_RETRABAJO = 'R' OR
                      ...
                      dbo.CONFIGURATIPO.CFT_TIPO = 'P') AND (dbo.FACTEXPDET.FED_INDICED = @FED_INDICED) AND (dbo.RETRABAJO.FETR_RETRABAJODES = 'S') AND 
