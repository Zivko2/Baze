...
CREATE PROCEDURE dbo.stpGrabaStruct(@codigo Int, @codigoPert int, @EntraVigor DateTime, @PerFin DateTime, @PerCamb Char(1), @Ma_tip_ens CHAR(1), @bst_sec smallint=0, @bst_codigo int output)   as
