...
CREATE PROCEDURE dbo.SP_DescContenedorFed (@CodigoFactura Int, @Fed_Indiced Int)   as
...
/*Contenedor 1 solamente */
		...
		SELECT     @CodigoFactura, @Fed_Indiced, dbo.FACTEXP.CJ_COMPANY1, 1, MAESTRO_1.ME_COM, MAESTRO_1.EQ_GEN, 
