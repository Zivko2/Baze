...
CREATE PROCEDURE [dbo].[SP_IMPORTDOCSENTRYNO] (@TABLA VARCHAR(150), @USER INT)   AS

exec('
DECLARE @Col_18 varchar(8000),@Col_19 varchar(8000),@FACTEXPDET#FED_COS_UNI float,@FACTEXPDET#FED_GRA_MO float,@FACTEXPDET#FED_GRA_GI_MX float,@FACTEXPDET#FED_NG_MP float,@FACTEXPDET#FED_OBSERVA varchar(8000),@FACTEXPDET#FED_PES_NET float,@FACTEXPDET#FED_PES_BRU float,@FACTEXPDET#FED_COS_TOT float,@FACTEXPDET#FED_NOPARTEAUX varchar(8000),@FACTEXP#TQ_CODIGO smallint,@FACTEXP#TF_CODIGO smallint,@FACTEXP#FE_TIPO char,@FACTEXP#FE_FECHA datetime,@FACTEXP#FE_FOLIO varchar(8000),@FACTEXP#FE_CONT1_REG varchar(8000),@FACTEXP#FE_CONT1_SELL varchar(8000),@FACTEXP#CL_DESTINI int,@FACTEXP#FE_TRAC_MX1 varchar(8000),@FACTEXP#FE_TRAC_US1 varchar(8000),@FACTEXP#FE_GUIA1 varchar(8000),@FACTEXP#FE_CONT1_US varchar(8000),@FACTEXP#FE_LIM1 varchar(8000),@FACTEXP#CT_COMPANY1 int,@FACTEXP#FE_TRAC_CHO1 varchar(8000),@FACTEXP#FE_FIRMS varchar(15),@FACTEXPDET#FED_NOPARTE varchar(8000),@FACTEXPDET#FED_CANT float,@FACTEXPDET#FED_CANTEMP float,@FACTEXPDET#MA_EMPAQUE int,@Cod_6 varchar(8000),@Cod_12 varchar(8000),@Cod_16 varchar(8000),@Cod_21 varchar(8000)
...
SELECT MAX(Col_18),MAX(Col_19),MAX(Cod_6),MAX(Cod_12),MAX(Cod_16),MAX(Cod_21),MAX(FACTEXP'+@USER+'#TQ_CODIGO),MAX(FACTEXP'+@USER+'#TF_CODIGO),FACTEXP'+@USER+'#FE_TIPO,MAX(FACTEXP'+@USER+'#FE_FECHA),FACTEXP'+@USER+'#FE_FOLIO,MAX(FACTEXP'+@USER+'#FE_CONT1_REG),MAX(FACTEXP'+@USER+'#FE_CONT1_SELL),MAX(FACTEXP'+@USER+'#CL_DESTINI),MAX(FACTEXP'+@USER+'#FE_TRAC_MX1),MAX(FACTEXP'+@USER+'#FE_TRAC_US1),MAX(FACTEXP'+@USER+'#FE_GUIA1),MAX(FACTEXP'+@USER+'#FE_CONT1_US),MAX(FACTEXP'+@USER+'#FE_LIM1),MAX(FACTEXP'+@USER+'#CT_COMPANY1),MAX(FACTEXP'+@USER+'#FE_TRAC_CHO1),MAX(FACTEXP'+@USER+'#FE_FIRMS) FROM '+@TABLA+' WHERE FACTEXP'+@USER+'#FE_FOLIO NOT IN (select factexp.fe_folio from factexp WHERE factexp.fe_estatus in (''A'', ''C'', ''P'', ''L'', ''S'') or fe_iniciocruce=''S'') GROUP BY FACTEXP'+@USER+'#FE_TIPO,FACTEXP'+@USER+'#FE_FOLIO
OPEN CUR_TEMPIMPORT162_1
FETCH NEXT FROM CUR_TEMPIMPORT162_1 INTO @Col_18 ,@Col_19 ,@Cod_6 ,@Cod_12 ,@Cod_16 ,@Cod_21 ,@FACTEXP#TQ_CODIGO ,@FACTEXP#TF_CODIGO ,@FACTEXP#FE_TIPO ,@FACTEXP#FE_FECHA ,@FACTEXP#FE_FOLIO ,@FACTEXP#FE_CONT1_REG ,@FACTEXP#FE_CONT1_SELL ,@FACTEXP#CL_DESTINI ,@FACTEXP#FE_TRAC_MX1 ,@FACTEXP#FE_TRAC_US1 ,@FACTEXP#FE_GUIA1 ,@FACTEXP#FE_CONT1_US ,@FACTEXP#FE_LIM1 ,@FACTEXP#CT_COMPANY1 ,@FACTEXP#FE_TRAC_CHO1 ,@FACTEXP#FE_FIRMS 
...
BEGIN
  ...
  BEGIN
          ...
          INSERT INTO FACTEXP (FE_CODIGO,TQ_CODIGO ,TF_CODIGO ,FE_TIPO ,FE_FECHA ,FE_FOLIO ,FE_CONT1_REG ,FE_CONT1_SELL ,CL_DESTINI ,FE_TRAC_MX1 ,FE_TRAC_US1 ,FE_GUIA1 ,FE_CONT1_US ,FE_LIM1 ,CT_COMPANY1 ,FE_TRAC_CHO1 ,FE_DESCRIPTION1 ,FE_HEADER ,FE_FOOTER ,AG_MX ,AG_US ,CL_PROD ,DI_PROD ,CL_COMP ,DI_COMP ,CL_COMPFIN ,DI_COMPFIN ,CL_EXP ,DI_EXP ,CL_EXPFIN ,DI_EXPFIN ,DI_DESTINI ,CL_DESTFIN ,DI_DESTFIN ,CL_VEND ,DI_VEND ,CL_IMP ,DI_IMP ,PU_CARGA ,PU_SALIDA ,PU_ENTRADA ,PU_DESTINO ,CT_COMPANY2 ,IT_COMPANY1 ,MT_COMPANY1 ,IT_COMPANY2 ,MT_COMPANY2 ,FE_TIPOCAMBIO ,MO_CODIGO ,FE_PINICIAL ,FE_PFINAL ,AGT_CODIGO ) VALUES (@CONSECUTIVO,@FACTEXP#TQ_CODIGO ,@FACTEXP#TF_CODIGO ,@FACTEXP#FE_TIPO ,@FACTEXP#FE_FECHA ,@FACTEXP#FE_FOLIO ,@FACTEXP#FE_CONT1_REG ,@FACTEXP#FE_CONT1_SELL ,@FACTEXP#CL_DESTINI ,@FACTEXP#FE_TRAC_MX1 ,@FACTEXP#FE_TRAC_US1 ,@FACTEXP#FE_GUIA1 ,@FACTEXP#FE_CONT1_US ,@FACTEXP#FE_LIM1 ,@FACTEXP#CT_COMPANY1 ,@FACTEXP#FE_TRAC_CHO1 ,@FACTEXP#FE_DESCRIPTION1,@FACTEXP#FE_HEADER,@FACTEXP#FE_FOOTER,@FACTEXP#AG_MX,@FACTEXP#AG_US,@FACTEXP#CL_PROD,@FACTEXP#DI_PROD,@FACTEXP#CL_COMP,@FACTEXP#DI_COMP,@FACTEXP#CL_COMPFIN,@FACTEXP#DI_COMPFIN,@FACTEXP#CL_EXP,@FACTEXP#DI_EXP,@FACTEXP#CL_EXPFIN,@FACTEXP#DI_EXPFIN,@FACTEXP#DI_DESTINI,@FACTEXP#CL_DESTFIN,@FACTEXP#DI_DESTFIN,@FACTEXP#CL_VEND,@FACTEXP#DI_VEND,@FACTEXP#CL_IMP,@FACTEXP#DI_IMP,@FACTEXP#PU_CARGA,@FACTEXP#PU_SALIDA,@FACTEXP#PU_ENTRADA,@FACTEXP#PU_DESTINO,@FACTEXP#CT_COMPANY2,@FACTEXP#IT_COMPANY1,@FACTEXP#MT_COMPANY1,@FACTEXP#IT_COMPANY2,@FACTEXP#MT_COMPANY2,@FACTEXP#FE_TIPOCAMBIO,@FACTEXP#MO_CODIGO,@FACTEXP#FE_PINICIAL,@FACTEXP#FE_PFINAL,@FACTEXP#AGT_CODIGO)

               INSERT INTO REGISTROSIMPORTADOS (RI_REGISTRO,RI_TIPO,RI_CBFORMA, RI_USERID) VALUES                                               (''FE_FOLIO = ''+CONVERT(varchar(100),@FACTEXP#FE_FOLIO)+'', ''+''FE_FECHA = ''+CONVERT(varchar(100),@FACTEXP#FE_FECHA),''I'',20,1) 
 if exists (select * from sysobjects where name=''sysusrlog62'')                 insert into sysusrlog62 (user_id, mov_id, referencia, frmtag, fechahora) values                                                        (1, 1 ,''FE_FOLIO = ''+CONVERT(varchar(100),@FACTEXP#FE_FOLIO)+'', ''+''FE_FECHA = ''+CONVERT(varchar(100),@FACTEXP#FE_FECHA),62, getdate()) 
 
---------------------------------------------------------------------------------------------------------------------------------------
		  --- 12 11 2011
		  UPDATE FACTEXP
		  SET FACTEXP.ETC_CODIGO =  (SELECT ENTRYCONS.ETC_CODIGO 
									FROM ENTRYCONS 
									WHERE ENTRYCONS.ETC_ENTRY_NO = @FACTEXP#FE_FIRMS)
		  FROM FACTEXP
		  WHERE FACTEXP.FE_CODIGO = @CONSECUTIVO
---------------------------------------------------------------------------------------------------------------------------------------

 
        DECLARE CUR_TEMPIMPORT162_1DET CURSOR FOR
        SELECT MAX(Col_18),MAX(Col_19),MAX(Cod_6),MAX(Cod_12),MAX(Cod_16),MAX(Cod_21),MAX(FACTEXPDET'+@USER+'#FED_COS_UNI),FACTEXPDET'+@USER+'#FED_GRA_MO,FACTEXPDET'+@USER+'#FED_GRA_GI_MX,FACTEXPDET'+@USER+'#FED_NG_MP,FACTEXPDET'+@USER+'#FED_OBSERVA,SUM(FACTEXPDET'+@USER+'#FED_PES_NET),SUM(FACTEXPDET'+@USER+'#FED_PES_BRU),SUM(FACTEXPDET'+@USER+'#FED_COS_TOT),FACTEXPDET'+@USER+'#FED_NOPARTEAUX,FACTEXPDET'+@USER+'#FED_NOPARTE,SUM(FACTEXPDET'+@USER+'#FED_CANT),SUM(FACTEXPDET'+@USER+'#FED_CANTEMP),FACTEXPDET'+@USER+'#MA_EMPAQUE FROM '+@TABLA+'   WHERE FACTEXP'+@USER+'#FE_FOLIO=@FACTEXP#FE_FOLIO AND FACTEXP'+@USER+'#FE_TIPO=@FACTEXP#FE_TIPO AND FACTEXP'+@USER+'#TQ_CODIGO=@FACTEXP#TQ_CODIGO GROUP BY FACTEXPDET'+@USER+'#FED_GRA_MO,FACTEXPDET'+@USER+'#FED_GRA_GI_MX,FACTEXPDET'+@USER+'#FED_NG_MP,FACTEXPDET'+@USER+'#FED_OBSERVA,FACTEXPDET'+@USER+'#FED_NOPARTEAUX,FACTEXPDET'+@USER+'#FED_NOPARTE,FACTEXPDET'+@USER+'#MA_EMPAQUE
        OPEN CUR_TEMPIMPORT162_1DET
                      FETCH NEXT FROM CUR_TEMPIMPORT162_1DET INTO @Col_18 ,@Col_19 ,@Cod_6 ,@Cod_12 ,@Cod_16 ,@Cod_21 ,@FACTEXPDET#FED_COS_UNI ,@FACTEXPDET#FED_GRA_MO ,@FACTEXPDET#FED_GRA_GI_MX ,@FACTEXPDET#FED_NG_MP ,@FACTEXPDET#FED_OBSERVA ,@FACTEXPDET#FED_PES_NET ,@FACTEXPDET#FED_PES_BRU ,@FACTEXPDET#FED_COS_TOT ,@FACTEXPDET#FED_NOPARTEAUX ,@FACTEXPDET#FED_NOPARTE ,@FACTEXPDET#FED_CANT ,@FACTEXPDET#FED_CANTEMP ,@FACTEXPDET#MA_EMPAQUE 
        WHILE (@@FETCH_STATUS = 0)
        BEGIN
           ...
           SELECT @FACTEXPDET#PA_CODIGO=ISNULL((SELECT ''PA_CODIGO''=CASE WHEN MAESTRO.MA_TIP_ENS=''A'' AND (SELECT CF_TCOCOMPRAIMP FROM CONFIGURACION)=''S'' THEN (CASE WHEN @FACTEXP#TQ_CODIGO<>16 THEN (SELECT ANEXO24.PA_ORIGENFIS FROM ANEXO24 WHERE ANEXO24.MA_CODIGO=MAESTRO.MA_CODIGO) ELSE PA_ORIGEN END) ELSE PA_ORIGEN END FROM MAESTRO WHERE MA_INV_GEN = ''I'' AND MA_NOPARTE=@FACTEXPDET#FED_NOPARTE AND MA_NOPARTEAUX=@FACTEXPDET#FED_NOPARTEAUX),154)
          ...
          EXEC SP_GETCONSECUTIVO @TIPO=''FED'',@VALUE=@CONSDET OUTPUT
                INSERT INTO FACTEXPDET (FED_INDICED,FE_CODIGO,FED_COS_UNI ,FED_GRA_MO ,FED_GRA_GI_MX ,FED_NG_MP ,FED_OBSERVA ,FED_PES_NET ,FED_PES_BRU ,FED_COS_TOT ,FED_NOPARTEAUX ,FED_NOPARTE ,FED_CANT ,FED_CANTEMP ,MA_EMPAQUE ,FED_PARTTYPE ,MA_STRUCT ,SE_CODIGO ,FED_FECHA_STRUCT ,FED_RETRABAJO ,TI_CODIGO ,TCO_CODIGO ,SPI_CODIGO ,PA_CODIGO ,ME_CODIGO ,ME_AREXPMX ,MA_GENERICO ,MA_CODIGO ,FED_TIP_ENS ,FED_SEC_IMP ,AR_EXPMX ,FED_POR_DEF ,FED_PES_UNILB ,FED_PES_UNI ,FED_NOMBRE ,FED_NG_USA ,FED_NG_EMP ,FED_NG_ADD ,FED_NAME ,FED_NAFTA ,FED_GRA_MP ,FED_GRA_GI ,FED_GRA_EMP ,FED_GRA_ADD ,FED_DISCHARGE ,FED_DEF_TIP ,EQ_IMPFO ,EQ_GEN ,EQ_EXPMX ,CS_CODIGO ,CL_CODIGO ,AR_IMPMX ,AR_IMPFO ,AR_ORIG ,AR_NG_EMP ,FED_RATEIMPFO ,ME_GENERICO ) VALUES (@CONSDET,@CONSECUTIVO,@FACTEXPDET#FED_COS_UNI ,@FACTEXPDET#FED_GRA_MO ,@FACTEXPDET#FED_GRA_GI_MX ,@FACTEXPDET#FED_NG_MP ,@FACTEXPDET#FED_OBSERVA ,@FACTEXPDET#FED_PES_NET ,@FACTEXPDET#FED_PES_BRU ,@FACTEXPDET#FED_COS_TOT ,@FACTEXPDET#FED_NOPARTEAUX ,@FACTEXPDET#FED_NOPARTE ,@FACTEXPDET#FED_CANT ,@FACTEXPDET#FED_CANTEMP ,@FACTEXPDET#MA_EMPAQUE ,@FACTEXPDET#FED_PARTTYPE,@FACTEXPDET#MA_STRUCT,@FACTEXPDET#SE_CODIGO,@FACTEXPDET#FED_FECHA_STRUCT,@FACTEXPDET#FED_RETRABAJO,@FACTEXPDET#TI_CODIGO,@FACTEXPDET#TCO_CODIGO,@FACTEXPDET#SPI_CODIGO,@FACTEXPDET#PA_CODIGO,@FACTEXPDET#ME_CODIGO,@FACTEXPDET#ME_AREXPMX,@FACTEXPDET#MA_GENERICO,@FACTEXPDET#MA_CODIGO,@FACTEXPDET#FED_TIP_ENS,@FACTEXPDET#FED_SEC_IMP,@FACTEXPDET#AR_EXPMX,@FACTEXPDET#FED_POR_DEF,@FACTEXPDET#FED_PES_UNILB,@FACTEXPDET#FED_PES_UNI,@FACTEXPDET#FED_NOMBRE,@FACTEXPDET#FED_NG_USA,@FACTEXPDET#FED_NG_EMP,@FACTEXPDET#FED_NG_ADD,@FACTEXPDET#FED_NAME,@FACTEXPDET#FED_NAFTA,@FACTEXPDET#FED_GRA_MP,@FACTEXPDET#FED_GRA_GI,@FACTEXPDET#FED_GRA_EMP,@FACTEXPDET#FED_GRA_ADD,@FACTEXPDET#FED_DISCHARGE,@FACTEXPDET#FED_DEF_TIP,@FACTEXPDET#EQ_IMPFO,@FACTEXPDET#EQ_GEN,@FACTEXPDET#EQ_EXPMX,@FACTEXPDET#CS_CODIGO,@FACTEXPDET#CL_CODIGO,@FACTEXPDET#AR_IMPMX,@FACTEXPDET#AR_IMPFO,@FACTEXPDET#AR_ORIG,@FACTEXPDET#AR_NG_EMP,@FACTEXPDET#FED_RATEIMPFO,@FACTEXPDET#ME_GENERICO)
...
LEFT OUTER JOIN VMAESTROCOST VMAESTROCOST$5254_1 ON MAESTRO$404_1.MA_CODIGO = VMAESTROCOST$5254_1.MA_CODIGO
              where FACTEXPDET.FED_INDICED = @CONSDET
              update FACTEXPDET set FED_COS_TOT = ( FACTEXPDET.FED_CANT * FACTEXPDET.FED_COS_UNI )
              from FACTEXPDET
              left outer join FACTEXP on  
             FACTEXP.FE_CODIGO = FACTEXPDET.FE_CODIGO
LEFT OUTER JOIN MAESTRO MAESTRO$404_1 ON FACTEXPDET.FED_NOPARTE = MAESTRO$404_1.MA_NOPARTE
LEFT OUTER JOIN VMAESTROCOST VMAESTROCOST$5254_1 ON MAESTRO$404_1.MA_CODIGO = VMAESTROCOST$5254_1.MA_CODIGO
              where FACTEXPDET.FED_INDICED = @CONSDET
              update FACTEXPDET set FED_PES_BRU = ( MAESTRO$404_1.MA_PESO_KG )
              from FACTEXPDET
              left outer join FACTEXP on  
             FACTEXP.FE_CODIGO = FACTEXPDET.FE_CODIGO
LEFT OUTER JOIN MAESTRO MAESTRO$404_1 ON FACTEXPDET.FED_NOPARTE = MAESTRO$404_1.MA_NOPARTE
LEFT OUTER JOIN VMAESTROCOST VMAESTROCOST$5254_1 ON MAESTRO$404_1.MA_CODIGO = VMAESTROCOST$5254_1.MA_CODIGO
              where FACTEXPDET.FED_INDICED = @CONSDET
              update FACTEXPDET set FED_PES_NET = ( MAESTRO$404_1.MA_PESO_KG )
              from FACTEXPDET
              left outer join FACTEXP on  
             FACTEXP.FE_CODIGO = FACTEXPDET.FE_CODIGO
LEFT OUTER JOIN MAESTRO MAESTRO$404_1 ON FACTEXPDET.FED_NOPARTE = MAESTRO$404_1.MA_NOPARTE
