...
CREATE PROCEDURE [dbo].[SP_FILL_BOM_ESTRUCTDESC] (@BST_PT Int, @BST_ENTRAVIGOR DateTime, @MENSAJE1 char(1)='N' output)   as
...
AND SUM(dbo.BOM_STRUCT.BST_INCORPOR) >0
 ...
 OPEN CUR_BOMSTRUCT
  ...
  BEGIN  
	...
	exec  SP_FILL_BOM_ESTRUCTDESC1 @BST_PT, @BST_HIJO, @BST_ENTRAVIGOR, @BST_PERINI, 
