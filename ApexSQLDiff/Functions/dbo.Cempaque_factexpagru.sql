...
CREATE FUNCTION dbo.Cempaque_factexpagru(@cf_pais_usa int, @cfq_tipo char(1), @cft_tipo char(1), @eq_gen decimal(28,14), @fed_cos_uni decimal(38,6), @fed_nafta char(1), @fed_ng_emp decimal(38,6), @pa_codigo int)
