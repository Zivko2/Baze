...
CREATE FUNCTION dbo.CmatNoGravable_factexpagru(@cf_pedexpvausa char(1), @cf_pais_usa int, @cfq_tipo char(1), @cft_tipo char(1), @eq_gen decimal(28,14), @fed_cos_uni decimal(38,6), @fed_gra_gi decimal(38,6), @fed_nafta char(1), @fed_ng_usa decimal(38,6), @pa_codigo int)
