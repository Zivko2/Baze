...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[KARDESPED_InformacionBaseParaCalcularPagoArt303] (
...
GO
ALTER TABLE [dbo].[KARDESPED_InformacionBaseParaCalcularPagoArt303] SET (LOCK_ESCALATION = TABLE)
GO
