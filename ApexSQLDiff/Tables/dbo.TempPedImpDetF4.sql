...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[TempPedImpDetF4] (
...
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_AR_EXPFO]
	DEFAULT (0) FOR [AR_EXPFO]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_AR_IMPMX]
	DEFAULT (0) FOR [AR_IMPMX]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_EQ_GENERICO]
	DEFAULT (1) FOR [EQ_GENERICO]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_EQ_IMPMX]
	DEFAULT (1) FOR [EQ_IMPMX]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_MA_GENERICO]
	DEFAULT (0) FOR [MA_GENERICO]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_CAN_AR]
	DEFAULT (0) FOR [PID_CAN_AR]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_CAN_GEN]
	DEFAULT (0) FOR [PID_CAN_GEN]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_CANT]
	DEFAULT (0) FOR [PID_CANT]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_COS_UNI]
	DEFAULT (0) FOR [PID_COS_UNI]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_COS_UNIGEN]
	DEFAULT (0) FOR [PID_COS_UNIGEN]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_COS_UNIMATGRA]
	DEFAULT (0) FOR [PID_COS_UNIMATGRA]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_COS_UNIVA]
	DEFAULT (0) FOR [PID_COS_UNIVA]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_CTOT_DLS]
	DEFAULT (0) FOR [PID_CTOT_DLS]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_CTOT_MN]
	DEFAULT (0) FOR [PID_CTOT_MN]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_DEF_TIP]
	DEFAULT ('G') FOR [PID_DEF_TIP]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_DESCARGABLE]
	DEFAULT ('S') FOR [PID_DESCARGABLE]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_IMPRIMIR]
	DEFAULT ('S') FOR [PID_IMPRIMIR]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_NOPARTE]
	DEFAULT ('') FOR [PID_NOPARTE]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_POR_DEF]
	DEFAULT (0) FOR [PID_POR_DEF]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_REGIONFIN]
	DEFAULT ('F') FOR [PID_REGIONFIN]
GO
ALTER TABLE [dbo].[TempPedImpDetF4]
	ADD
	CONSTRAINT [DF_TempPedImpDetF4_PID_VAL_ADU]
	DEFAULT (0) FOR [PID_VAL_ADU]
GO
ALTER TABLE [dbo].[TempPedImpDetF4] SET (LOCK_ESCALATION = TABLE)
GO
