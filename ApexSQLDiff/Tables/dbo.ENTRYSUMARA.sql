...
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [PK_ENTRYSUMARA]
	PRIMARY KEY
	NONCLUSTERED
	([ETA_CODIGO])
	ON [PRIMARY]
...
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_ADV_CDVCASE]
	DEFAULT ('') FOR [ETA_ADV_CDVCASE]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_ADV_CDVRATE]
	DEFAULT (0) FOR [ETA_ADV_CDVRATE]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_CANT]
	DEFAULT (0) FOR [ETA_CANT]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_CHGS]
	DEFAULT (0) FOR [ETA_CHGS]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_COS_TOT]
	DEFAULT (0) FOR [ETA_COS_TOT]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_DLLS_IRC]
	DEFAULT (0) FOR [ETA_DLLS_IRC]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_DLLS_MPF]
	DEFAULT (0) FOR [ETA_DLLS_MPF]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_DLLS_RATE]
	DEFAULT (0) FOR [ETA_DLLS_RATE]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_DLLS_VISA]
	DEFAULT (0) FOR [ETA_DLLS_VISA]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_GRAV_MAT]
	DEFAULT (0) FOR [ETA_GRAV_MAT]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_GRAV_VA]
	DEFAULT (0) FOR [ETA_GRAV_VA]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_IRC]
	DEFAULT (0) FOR [ETA_IRC]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_MPF]
	DEFAULT (0) FOR [ETA_MPF]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_NG_EMP]
	DEFAULT (0) FOR [ETA_NG_EMP]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_NG_MAT]
	DEFAULT (0) FOR [ETA_NG_MAT]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_NG_VA]
	DEFAULT (0) FOR [ETA_NG_VA]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_RATE]
	DEFAULT (0) FOR [ETA_RATE]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_RELATIONSHIP]
	DEFAULT ('N') FOR [ETA_RELATIONSHIP]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_VISA]
	DEFAULT (0) FOR [ETA_VISA]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_WMPF]
	DEFAULT (0) FOR [ETA_WMPF]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETA_WOMPF]
	DEFAULT (0) FOR [ETA_WOMPF]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_ETD_LINE]
	DEFAULT ('') FOR [ETD_LINE]
GO
ALTER TABLE [dbo].[ENTRYSUMARA]
	ADD
	CONSTRAINT [DF_ENTRYSUMARA_MA_NAFTA]
	DEFAULT ('N') FOR [MA_NAFTA]
GO
CREATE CLUSTERED INDEX [IX_ENTRYSUMARA]
	ON [dbo].[ENTRYSUMARA] ([ET_CODIGO], [ETA_CODIGO])
	ON [PRIMARY]
GO
ALTER TABLE [dbo].[ENTRYSUMARA] SET (LOCK_ESCALATION = TABLE)
GO
