...
CREATE TABLE [dbo].[Incidencias] (
		[Codigo]                                        [bigint] NULL,
		[EncontroSaldo]                                 [int] NOT NULL,
		[EstatusOriginal]                               [char](1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
		...
		[DescripcionAlternativa]                        [varchar](150) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[Incidencias] SET (LOCK_ESCALATION = TABLE)
GO
