...
GO
ALTER TABLE [dbo].[ORDCOMPRADET]
	ADD
	CONSTRAINT [PK_ORDCOMPRADET]
	PRIMARY KEY
	NONCLUSTERED
	([ORD_INDICED])
	ON [PRIMARY]
...
ALTER TABLE [dbo].[ORDCOMPRADET]
	ADD
	CONSTRAINT [DF_ORDCOMPRADET_ORD_ENUSO]
	DEFAULT ('N') FOR [ORD_ENUSO]
GO
ALTER TABLE [dbo].[ORDCOMPRADET]
	ADD
	CONSTRAINT [DF_ORDCOMPRADET_ORD_NOPARTE]
	DEFAULT ('') FOR [ORD_NOPARTE]
GO
ALTER TABLE [dbo].[ORDCOMPRADET]
	ADD
	CONSTRAINT [DF_ORDCOMPRADET_ORD_NOPARTEPROVEE]
	DEFAULT ('') FOR [ORD_NOPARTEPROVEE]
GO
ALTER TABLE [dbo].[ORDCOMPRADET] SET (LOCK_ESCALATION = TABLE)
GO
